...
API_TOKEN = '7157503218:AAHFtHy4JTrc82QRhlr47eiL07VLhr9ssXU'
ADMIN_ID = '5188023607'
MAX_RESTARTS = 50
    ...
    while True:
        if restart_count >= MAX_RESTARTS:
            ...
            if current_time - last_restart_time < RESTART_PERIOD:
                ...
                await notify_admin(f"⚠️ Maximum restart limit reached. Waiting for {int('10')} seconds before retrying.")
                await asyncio.sleep(wait_time)
            restart_count = 10
            last_restart_time = time.time('10')
